...
# import unittest
#
# from aws_google_auth.configuration.cli_args import ArgumentParser
#
#
...
#         """
#             This test case exists to validate the default settings of the
#             args parser.  Changes that break these checks should be
#             considered for backwards compatibility review.
#             :return:
#         """
...
#
#         # Assert the size of the parameter so that new parameters
#         # trigger a review of this function and the appropriate defaults are
#         # added here to track backwards compatibility in the future.
