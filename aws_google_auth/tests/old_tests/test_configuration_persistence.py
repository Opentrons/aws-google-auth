...
#         self.c.password = "aws_google_auth_test_password_{}".format(
#             randint(100, 999))
#
...
#
#     def tearDown(self):
#         section_name = configuration.Configuration.config_profile(
#             self.c.profile)
...
#         profile_string = configuration.Configuration.config_profile(
#             self.c.profile)
#         self.assertTrue(self.config_parser.has_section(profile_string))
#         self.assertEqual(self.config_parser[profile_string]
#                          .get('google_config.google_idp_id'),
#                          self.c.idp_id)
#         self.assertEqual(self.config_parser[profile_string]
#                          .get('google_config.role_arn'),
#                          self.c.role_arn)
#         self.assertEqual(self.config_parser[profile_string]
#                          .get('google_config.google_sp_id'),
#                          self.c.sp_id)
#         self.assertEqual(self.config_parser[profile_string]
#                          .get('google_config.google_username'),
#                          self.c.username)
#         self.assertEqual(self.config_parser[profile_string]
#                          .get('region'),
#                          self.c.region)
#         self.assertEqual(self.config_parser[profile_string]
#                          .getboolean('google_config.ask_role'),
#                          self.c.ask_role)
#         self.assertEqual(self.config_parser[profile_string]
#                          .getboolean('google_config.keyring'),
#                          self.c.keyring)
#         # self.assertEqual(self.config_parser[profile_string]
#         # .getboolean('google_config.u2f_disabled'),
#         # self.c.u2f_disabled)
#         self.assertEqual(self.config_parser[profile_string]
#                          .getint('google_config.duration'),
#                          self.c.duration)
#         self.assertEqual(self.config_parser[profile_string]
#                          .get('google_config.bg_response'),
#                          self.c.bg_response)
#
#     def test_password_not_written(self):
#         profile_string = configuration.Configuration.config_profile(
#             self.c.profile)
#         self.assertIsNone(self.config_parser[profile_string].get(
#             'google_config.password', None))
#         self.assertIsNone(self.config_parser[profile_string].get(
#             'password', None))
#
...
#         # self.assertEqual(test_configuration.u2f_disabled,
#         # self.c.u2f_disabled)
