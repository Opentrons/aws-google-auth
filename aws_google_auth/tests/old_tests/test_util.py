...
#         self.assertEqual(
#             util.Util.coalesce(None, "test-01", None, "test-02", None,
#                                "test-03"), "test-01")
#         self.assertEqual(
#             util.Util.coalesce("test-01", None, "test-02", None, "test-03",
#                                None), "test-01")
#         self.assertEqual(
#             util.Util.coalesce(None, None, None, None, None, None, None, None,
#                                None, None, "test-01"), "test-01")
#
...
#             self.assertEqual(
#                 util.Util.unicode_to_string_if_needed(value_string),
#                 value_string)
#
...
#             self.assertEqual(
#                 util.Util.unicode_to_string_if_needed(value_unicode),
#                 value_string)
#             self.assertEqual(
#                 util.Util.unicode_to_string_if_needed(value_string),
#                 value_string)
