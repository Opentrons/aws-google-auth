...
#         self.assertEqual(configuration.Configuration.config_profile('default'),
#                          'default')
#         self.assertEqual(configuration.Configuration.config_profile('DEFAULT'),
#                          'DEFAULT')
#         self.assertEqual(configuration.Configuration.config_profile('testing'),
#                          'profile testing')
#         self.assertEqual(configuration.Configuration.config_profile(None),
#                          'profile None')
#         self.assertEqual(configuration.Configuration.config_profile(123456),
#                          'profile 123456')
#
...
#         with self.assertRaises(AssertionError) as e:
#             c.raise_if_invalid()
#         self.assertIn("Expected duration to be greater than or equal to 900.",
#                       str(e.exception))
#
...
#         with self.assertRaises(AssertionError) as e:
#             c.raise_if_invalid()
#         self.assertIn("Expected idp_id to be set to non-None value.",
#                       str(e.exception))
#
...
#         with self.assertRaises(AssertionError) as e:
#             c.raise_if_invalid()
#         self.assertIn("Expected sp_id to be set to non-None value.",
#                       str(e.exception))
#
...
#         with self.assertRaises(AssertionError) as e:
#             c.raise_if_invalid()
#         self.assertIn("Expected role_arn to be None or a string.",
#                       str(e.exception))
#
...
#         with self.assertRaises(AssertionError) as e:
#             c.raise_if_invalid()
#         self.assertIn("Expected role_arn to contain 'arn:aws:iam::'",
#                       str(e.exception))
#
...
#     #     with self.assertRaises(AssertionError) as e:
#     #         c.raise_if_invalid()
#     #     self.assertIn("Expected u2f_disabled to be a boolean.",
#     #     str(e.exception))
#
