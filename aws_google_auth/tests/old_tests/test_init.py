...
#         """
#         This is the entrypoint for the cli tool, and should require no
#         parameters
#
#         :param mock_cli:
#         :return:
...
#                 'arn:aws:iam::123456789012:saml-provider/GoogleApps',
#             'arn:aws:iam::123456789012:role/read-only':
#                 'arn:aws:iam::123456789012:saml-provider/GoogleApps'
#         }
#
#         mock_util_obj = MagicMock()
#         mock_util_obj.pick_a_role = MagicMock(
#             return_value=("da_role", "da_provider"))
#         mock_util_obj.get_input = MagicMock(
#             side_effect=["region_input", "input", "input2", "input3"])
...
#                           #     {'arn:aws:iam::
#                           #     123456789012:role/read-only':
#                           #     'arn:aws:iam::
#                           #         123456789012:saml-provider/GoogleApps',
#                           #     'arn:aws:iam::
#                           #         123456789012:role/admin':
#                           #     'arn:aws:iam::
#                           #         123456789012:saml-provider/GoogleApps'
#                           #         }, [])
#                           ],
...
#     @patch('aws_google_auth.amazon', spec=True)
#     @patch('aws_google_auth.google', spec=True)
#     def test_process_auth_print_creds(self,
#                                       mock_google,
#                                       mock_amazon,
#                                       mock_util):
#         mock_config = Mock()
...
#             return_value=("da_role", "da_provider"))
#         mock_util_obj.get_input = MagicMock(
#             side_effect=["input", "input2", "input3"])
#         mock_util_obj.get_password = MagicMock(return_value="pass")
#
#         mock_util.Util = mock_util_obj
#
...
#     @patch('aws_google_auth.amazon', spec=True)
#     @patch('aws_google_auth.google', spec=True)
#     def test_process_auth_specified_role(self, mock_google, mock_amazon,
#                                          mock_util):
#         mock_config = Mock()
#         mock_config.saml_cache = False
#         mock_config.keyring = False
...
#         self.assertEqual(mock_config.sp_id, "input3")
#         self.assertEqual(mock_config.password, "pass")
#         self.assertEqual(mock_config.provider,
#                          "arn:aws:iam::123456789012:saml-provider/GoogleApps")
#         self.assertEqual(mock_config.role_arn,
#                          "arn:aws:iam::123456789012:role/admin")
#
#         # Assert calls occur
...
#     @patch('aws_google_auth.amazon', spec=True)
#     @patch('aws_google_auth.google', spec=True)
#     def test_process_auth_dont_resolve_alias(self, mock_google, mock_amazon,
#                                              mock_util):
#         mock_config = Mock()
#         mock_config.saml_cache = False
...
#     @patch('aws_google_auth.amazon', spec=True)
#     @patch('aws_google_auth.google', spec=True)
#     def test_process_auth_with_profile(self, mock_google, mock_amazon,
#                                        mock_util):
#         mock_config = Mock()
#         mock_config.saml_cache = False
#         mock_config.keyring = False
...
#     @patch('aws_google_auth.amazon', spec=True)
#     @patch('aws_google_auth.google', spec=True)
#     def test_process_auth_with_saml_cache(self, mock_google, mock_amazon,
#                                           mock_util):
#         mock_config = Mock()
...
#
#         # Assert calls occur
#         self.assertEqual([call.Util.pick_a_role({
#             'arn:aws:iam::123456789012:role/read-only':
#                 'arn:aws:iam::123456789012:saml-provider/GoogleApps',
#             'arn:aws:iam::123456789012:role/admin':
#                 'arn:aws:iam::123456789012:saml-provider/GoogleApps'},
