...
#             self.c.profile)
#         self.assertTrue(
#             self.config_parser.has_section(profile_string))
#         self.assertEqual(
#             self.config_parser[profile_string]
...
#         self.assertEqual(
#             self.config_parser[profile_string]
#                 .get('region'), self.c.region)
#         self.assertEqual(
#             self.config_parser[profile_string]
#                 .getboolean('google_config.ask_role'), self.c.ask_role)
